...
export interface SidplayExports {
  ...
  readonly cawtooth_sidplay_set_extra_sid: (index: number, baseAddr: number, model: number) => void;
  readonly cawtooth_sidplay_load: (loadAddr: number, dataPtr: number, length: number) => void;
